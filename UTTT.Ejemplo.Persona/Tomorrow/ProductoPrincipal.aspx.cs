...
{
    public partial class ProductoPrincipal : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                this.session.Pantalla = "~/Tomorrow/ProductoManager.aspx";
        ...
        protected void DataSourcePersona_Selecting(object sender, LinqDataSourceSelectEventArgs e)
        {
            try
            {
                ...
                Expression<Func<UTTT.Ejemplo.Linq.Data.Entity.Producto, bool>> 
                    predicate =
                    (c =>          
                ...
                List<UTTT.Ejemplo.Linq.Data.Entity.Producto> lista =
                    dcConsulta.GetTable<UTTT.Ejemplo.Linq.Data.Entity.Producto>().Where(predicate).ToList();
        ...
        private void eliminar(int _idPersona)
        {
            try
            {
                ...
                UTTT.Ejemplo.Linq.Data.Entity.Producto persona = dcDelete.GetTable<UTTT.Ejemplo.Linq.Data.Entity.Producto>().First(
                    c => c.Id == _idPersona);
                dcDelete.GetTable<UTTT.Ejemplo.Linq.Data.Entity.Producto>().DeleteOnSubmit(persona);
