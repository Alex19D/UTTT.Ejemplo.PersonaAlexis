...
{
    public partial class DireccionLManager : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    this.baseEntity = dcGlobal.GetTable<Linq.Data.Entity.Locales>().First(c => c.Id == this.idPersona);
                    this.txtPersona.Text = this.baseEntity.strClaveLocal + ", de tipo " + this.baseEntity.CatTipoLocal;
                    if (this.baseEntity.DireccionLocal.Count() == 0)
                    {
            ...
            catch (Exception _e)
            {
                ...
                this.Response.Redirect("~/Tomorrow/LocalesPrincipal.aspx", false);
            }
        }
        ...
        protected void LinqDataSourceDireccion_Selecting(object sender, LinqDataSourceSelectEventArgs e)
        {
            try
            {
                ...
                Expression<Func<UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal, bool>>
                    predicate = c => c.Local_id == this.idPersona;
                predicate.Compile();
                List<UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal> listaPersona =
                    dcConsulta.GetTable<UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal>().Where(predicate).ToList();
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                this.session.Pantalla = "~/Tomorrow/DireccionExtraLManager.aspx";
        ...
        private void eliminar(int _idDireccion)
        {
            try
            {
                ...
                UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal direccion = dcDelete.GetTable<UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal>().First(
                    c => c.Id == _idDireccion);
                dcDelete.GetTable<UTTT.Ejemplo.Linq.Data.Entity.DireccionLocal>().DeleteOnSubmit(direccion);
        ...
        {
            Response.Redirect("~/Tomorrow/LocalesPrincipal.aspx", false);
        }
    }
}